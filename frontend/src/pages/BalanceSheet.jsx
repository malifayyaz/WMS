                    ...
                    <TableContainer>
                      <Table size="small">
                        <TableBody>
                          ...
                          <TableRow hover>
                            <TableCell sx={{ py: 1, border: 0 }}>
                              Coil at Annealer (Bhatti) ({assets.totalAnnealingStockKg || 0} kg)
                            </TableCell>
                            <TableCell align="right" sx={{ py: 1, border: 0, fontWeight: 700 }}>
                              {formatCurrency(assets.annealingStockValue || 0)}
                            </TableCell>
                          </TableRow>
                          ...
                          <TableRow sx={{ bgcolor: isDark ? 'rgba(59, 130, 246, 0.08)' : '#EFF6FF' }}>
                            <TableCell sx={{ py: 1, fontWeight: 700, color: 'primary.dark' }}>
                              Subtotal — Inventory ({(assets.rawMaterialWeightKg || 0) + (assets.totalReadyStockKg || 0) + (assets.totalProcessingStockKg || 0) + (assets.totalAnnealingStockKg || 0)} kg total)
                            </TableCell>
                            <TableCell align="right" sx={{ py: 1, fontWeight: 800, color: 'primary.dark' }}>
